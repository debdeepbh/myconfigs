...
- [x] palm-rejection
	...
	- and then restart `lightdm`
	    ...
	    ```
- [?] [how to cancel?] fingerprint login x11 apps
- [ ] sleep on lid close
- [?] [inconsitent] wifi issue
- [?] [inconsitent] lock screen with xflock4
- [ ] heating: updated firmware to latest
- [ ] maximum cpu frequency on battery
- [ ] [inconsistent] reboot delay
- [ ] ps mouse
